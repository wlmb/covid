...
set xrange [ 10 : 400000 ] noreverse writeback
set x2range [ * : * ] noreverse writeback
set ylabel "Decesos diarios confirmados"
...
fit f(a,K,x) 'mx.txt' u 7:3 via a,K
## Last datafile plotted: "mx.txt"
plot 'mx.txt' u 7:3 w lp pi int ti 'Mexico', f(a,K,x) w l ti sprintf("Gompertz, saturacion=%.3g", K), f(a-a_err,K+K_err,x) w l ti sprintf("Pesimista, saturacion=%.3g", K+K_err), f(a+a_err,K-K_err,x) w l ti sprintf("Optimista, saturacion=%.3g", K-K_err)
## fit f(x) 'mx.txt' u 7:3 via a,K
#    EOF
