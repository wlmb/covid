...
plot "kr.txt" u ($4*1000000):($5*1000000) w lp lt 1 ti "Korea", "cn.txt" u ($4*1000000):($5*1000000) w lp lt 2 ti "China", "es.txt" u ($4*1000000):($5*1000000) w lp lt 3 ti "España", "it.txt" u ($4*1000000):($5*1000000) w lp lt 4 ti "Italia", "ru.txt" u ($4*1000000):($5*1000000) w lp lt 5 ti "Rusia", "us.txt" u ($4*1000000):($5*1000000) w lp lt 6 ti "EUA", "jp.txt" u ($4*1000000):($5*1000000) w lp lt 8 ti "Japón", "ar.txt" u ($4*1000000):($5*1000000) w lp lt 9 ti "Argentina", "pe.txt" u ($4*1000000):($5*1000000) w lp lt 10 ti "Perú", "pa.txt" u ($4*1000000):($5*1000000) w lp lt 11 ti "Panamá", "co.txt" u ($4*1000000):($5*1000000) w lp lt 12 ti "Colombia", "mx.txt" u ($4*1000000):($5*1000000) w lp lt 7 lw 2 ti "México"
#    EOF
