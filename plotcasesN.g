...
plot "kr.txt" ev 1 u ($4*1e6):($5*1e6) w lp lt 1 ti "Korea", "cn.txt" ev 1 u ($4*1e6):($5*1e6) w lp lt 2 ti "China", "es.txt" ev 1 u ($4*1e6):($5*1e6) w lp lt 3 ti "España", "it.txt" ev 1 u ($4*1e6):($5*1e6) w lp lt 4 ti "Italia", "ru.txt" ev 1 u ($4*1e6):($5*1e6) w lp lt 5 ti "Rusia", "us.txt" ev 1 u ($4*1e6):($5*1e6) w lp lt 6 ti "EUA", "jp.txt" ev 1 u ($4*1e6):($5*1e6) w lp lt 8 ti "Japón", "ar.txt" ev 1 u ($4*1e6):($5*1e6) w lp lt 9 ti "Argentina", "pe.txt" ev 1 u ($4*1e6):($5*1e6) w lp lt 10 ti "Perú", "pa.txt" ev 1 u ($4*1e6):($5*1e6) w lp lt 11 ti "Panamá", "co.txt" ev 1 u ($4*1e6):($5*1e6) w lp lt 12 ti "Colombia", "de.txt" ev 1 u ($4*1e6):($5*1e6) w lp lt 12 ti "Alemania", "se.txt" ev 1 u ($4*1e6):($5*1e6) w lp lt 12 ti "Suecia", "mx.txt" ev 1 u ($4*1e6):($5*1e6) w lp lt 7 lw 2 ti "México"
#    EOF
